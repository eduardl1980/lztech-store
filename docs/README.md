# Historial de Sesiones — LZ Tech Store

Cada archivo en `sesiones/` representa una sesión de trabajo con el asistente.

## Nomenclatura de archivos
```
sesiones/YYYY-MM-DD_HH-MM_[nombre-sesion].md
```
...
**Accion:** [archivos tocados, decisiones, resultado]
```
